    ...
    <section id="home">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <p className="text-blue-100 max-w-80 uppercase tracking-widest text-xs text-center">
            Dynamic Web Magic with Next.js
          </p>
          <TextGenerateEffect
            className="text-center text-[40px] md:text-5px lg:text-6xl"
            words="Transforming Concepts into Seamless User Experiences"
          />
          <p className="md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi I&apos;am, a Software Developer based in Kolkata, India
          </p>
          <Link href="#about">
            <MagicButton
              title="Show My Work"
